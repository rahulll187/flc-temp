      ...
      <View style={styles.response}>
        <View style={[styles.textBoxContainer, { height: this.state.height }]}>
          ...
          {this.props.isSending
            ...
            : <TouchableOpacity style={styles.sendButton}onPress={this.props.onMessageSend}>
              {this.props.isHideSendIcon &&
              <SendIcon fill={'transparent'} width="24" height="24" />
            ||<SendIcon fill={Colors.appThemeColor} width="24" height="24" />
            }
            </TouchableOpacity>
          }
        </View>
