...
class ChatProjects extends Component {
  constructor(props) {
    super(props)
  ...
  shouldComponentUpdate(nextProps) {
    ...
    return Actions.currentScene === 'ChatProjects'
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      if (Actions.currentScene === "ChatProjects") {
        Actions.ChatMembers()
      }
    }
  }
  ...
  renderListItem(projects) {
    const { ProjectName } = projects.item
    ...
    return (
      <View style={styles.projectContainer} key={StoreId}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ChatProjects);
